...
var import_dist10, import_dist11, import_dist12, extendStatics, __assign;
...
var Jn = class extends An {
  ...
  process(e2, n3) {
    for (let d3 = 0; d3 < 16; d3++, n3 += 4) P2[d3] = e2.getUint32(n3), Q[d3] = e2.getUint32(n3 += 4);
    for (let d3 = 16; d3 < 80; d3++) {
      const m2 = P2[d3 - 15] | 0, F = Q[d3 - 15] | 0, q = x.rotrSH(m2, F, 1) ^ x.rotrSH(m2, F, 8) ^ x.shrSH(m2, F, 7), z2 = x.rotrSL(m2, F, 1) ^ x.rotrSL(m2, F, 8) ^ x.shrSL(m2, F, 7), I = P2[d3 - 2] | 0, O3 = Q[d3 - 2] | 0, ot = x.rotrSH(I, O3, 19) ^ x.rotrBH(I, O3, 61) ^ x.shrSH(I, O3, 6), tt = x.rotrSL(I, O3, 19) ^ x.rotrBL(I, O3, 61) ^ x.shrSL(I, O3, 6), st = x.add4L(z2, tt, Q[d3 - 7], Q[d3 - 16]), at = x.add4H(st, q, ot, P2[d3 - 7], P2[d3 - 16]);
      P2[d3] = at | 0, Q[d3] = st | 0;
    }
...
function yr(t) {
  const e2 = gr(t), { Fp: n3, n: r3, prehash: o5, hash: s2, randomBytes: a2, nByteLength: u, h: i2 } = e2, D2 = yt << BigInt(u * 8) - j2, c4 = n3.create, l5 = _e(e2.n, e2.nBitLength), p2 = e2.uvRatio || ((y2, f3) => {
    try {
  ...
  class d3 {
    ...
    static fromAffine(f3) {
      ...
      const { x: b2, y: E3 } = f3 || {};
      return g3("x", b2), g3("y", E3), new d3(b2, E3, j2, c4(b2 * E3));
    }
    ...
    multiplyUnsafe(f3, b2 = d3.ZERO) {
      const E3 = f3;
      return ft("scalar", E3, G, r3), E3 === G ? F : this.is0() || E3 === j2 ? this : q.wNAFCachedUnsafe(this, E3, d3.normalizeZ, b2);
    }
    isSmallOrder() {
    ...
    toRawBytes() {
      ...
      return E3[E3.length - 1] |= f3 & j2 ? 128 : 0, E3;
    }
    toHex() {
      return Ft(this.toRawBytes());
    }
  }
  d3.BASE = new d3(e2.Gx, e2.Gy, j2, c4(e2.Gx * e2.Gy)), d3.ZERO = new d3(G, j2, j2, G);
...
*/
//# sourceMappingURL=chunk-EF3AF7NV.js.map
